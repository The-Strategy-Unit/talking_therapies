...
subtitle: "Evaluation of interventions to improve adherence to therapy in *NHS Tower Hamlets Talking Therapies*"
author: "Craig Parylo"
date: today
...
params <- list(
  "ods_intervention" = "RWK53",
  "intervention_long_name" = "NHS Tower Hamlets Talking Therapies",
  "intervention_short_name" = "Tower Hamlets TT",
  "download_from_teams" = FALSE,
  "zoo_intervention_month" = zoo::as.yearmon("Mar 2025")
)
...
-   Outcome 1 showed a mixture of slightly positive and slightly negative trends, but none reached statistical significance.
...
## Outcomes for Tower Hamlets Talking Therapies
...
Following the commencement of activity in January 2022, three months stand out for having notably lower referral discharge volumes:

-   **May 2022**: 18 discharges

-   **September 2023**: 28 discharges

-   **May 2024**: 13 discharges
...
df_temp <-
  ...
  dplyr::filter(
    ...
    !calc_month %in% zoo::as.yearmon(c("May 2022", "Sep 2023", "May 2024"))
  )
...
df_temp |>
  plot_outcomes_over_time(
    ...
    subtitle = stringr::str_wrap(
      string = glue::glue(
        "Outcome 1 declined by {scales::percent(rate_per_year, accuracy = 0.1)} per year from 2022 to 2025"
      ),
      width = 50
    )
  )
...
saveRDS(
  object = did_meta,
  file = here::here("data", "project", "did_estimates", "tower_hamlets.Rds")
)
```
