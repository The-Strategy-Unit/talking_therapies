...
df_prep <-
  ...
  dplyr::filter(
    ...
    max(calc_month, na.rm = TRUE) >= zoo::as.yearmon("Jul 2025"),
...
matches_parallel_ods <- c("RV3L8", "RXX1Y", "RWK79")
...
- For outcome 1 the DiD estimate becomes slightly more negative and the confidence interval is narrows.  
