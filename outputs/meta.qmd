...
df_meta <-
  ...
  dplyr::mutate(
    ...
    model_main = stringr::str_detect(string = specification, pattern = "main")
  )
...
```{r}
#| label: subgroup - outcome 1 - psm - analysis
...
```{r}
#| label: subgroup - outcome 1 - psm - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 1 - psm - details
meta$analysis
```
...
```{r}
#| label: subgroup - outcome 1 - cem - analysis
...
```{r}
#| label: subgroup - outcome 1 - cem - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 1 - cem - details
meta$analysis
```
...
```{r}
#| label: subgroup - outcome 1 - synth - analysis
...
```{r}
#| label: subgroup - outcome 1 - synth - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 1 - synth - details
meta$analysis
```
...
```{r}
#| label: subgroup - outcome 2 - psm - analysis
...
```{r}
#| label: subgroup - outcome 2 - psm - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 2 - psm - details
meta$analysis
```
...
```{r}
#| label: subgroup - outcome 2 - cem - analysis
...
```{r}
#| label: subgroup - outcome 2 - cem - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 2 - cem - details
meta$analysis
```
...
```{r}
#| label: subgroup - outcome 2 - synth - analysis
...
```{r}
#| label: subgroup - outcome 2 - synth - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup - outcome 2 - synth - details
meta$analysis
```
