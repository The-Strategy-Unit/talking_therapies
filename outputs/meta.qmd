...
# initialise the summary table (will hold the extracted details from each meta analysis)
list_summary_table <- list()
...
```{r}
#| label: outcome 2 - synth_matched - analysis
...
```{r}
#| label: outcome 2 - synth_matched - forest
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: outcome 2 - synth_matched - details
meta$analysis
```
...
```{r}
#| label: subgroup 1 - outcome 1 - synth_matched - analysis
meta <- conduct_meta_analysis(
  .df = df_meta,
  .subgroup = "sub_component",
  .outcome = "Outcome 1",
...
```{r}
#| label: subgroup 1 - outcome 1 - synth_matched - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup 1 - outcome 1 - synth_matched - details
meta$analysis
```
...
```{r}
#| label: subgroup 1 - outcome 2 - synth_matched - analysis
meta <- conduct_meta_analysis(
  .df = df_meta,
  .subgroup = "sub_component",
  .outcome = "Outcome 2",
...
```{r}
#| label: subgroup 1 - outcome 2 - synth_matched - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup 1 - outcome 2 - synth_matched - details
meta$analysis
```
...
```{r}
#| label: subgroup 2 - outcome 1 - synth_matched - analysis
meta <- conduct_meta_analysis(
  .df = df_meta,
  .subgroup = "sub_targetgroup",
  .outcome = "Outcome 1",
...
```{r}
#| label: subgroup 2 - outcome 1 - synth_matched - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup 2 - outcome 1 - synth_matched - details
meta$analysis
```
...
```{r}
#| label: subgroup 2 - outcome 2 - synth_matched - analysis
meta <- conduct_meta_analysis(
  .df = df_meta,
  .subgroup = "sub_targetgroup",
  .outcome = "Outcome 2",
...
```{r}
#| label: subgroup 2 - outcome 2 - synth_matched - forest
#| fig-height: 5
meta$analysis |> display_forest_plot()
```
...
```{r}
#| label: subgroup 2 - outcome 2 - synth_matched - details
meta$analysis
```
...
```{r}
get_gt_summary_table(list_summary_table)
```

# Cross-model ranking of service performance
```{r}
list_summary_table |> rank_service_over_models(.outcome = "Outcome 1")
list_summary_table |> rank_service_over_models(.outcome = "Outcome 2")
```