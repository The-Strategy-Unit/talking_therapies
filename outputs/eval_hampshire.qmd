...
params <- list(
  "ods_intervention" = "RW1",
  "intervention_long_name" = "NHS Talking Therapies Hampshire",
  "intervention_short_name" = "NHS TT Hampshire",
  "download_from_teams" = FALSE,
  "zoo_intervention_month" = zoo::as.yearmon("Nov 2023")
)
