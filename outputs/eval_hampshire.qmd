...
# browseURL(here::here('data', 'project', 'tt_interventions_summary.xlsx'))
...
-   Across all three methods, Outcome 1 shows a significant reduction only in the CEM model, while Outcome 2 consistently shows no significant effects.
